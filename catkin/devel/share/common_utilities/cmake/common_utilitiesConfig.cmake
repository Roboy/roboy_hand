...
if("TRUE" STREQUAL "TRUE")
  set(common_utilities_SOURCE_PREFIX /home/sausy/Projects/Hand_openBionic/catkin/src/common_utilities)
  set(common_utilities_DEVEL_PREFIX /home/sausy/Projects/Hand_openBionic/catkin/devel)
  ...
  set(common_utilities_INSTALL_PREFIX /home/sausy/Projects/Hand_openBionic/catkin/install)
...
if(NOT "/home/sausy/Projects/Hand_openBionic/catkin/src/common_utilities/include " STREQUAL " ")
  set(common_utilities_INCLUDE_DIRS "")
  set(_include_dirs "/home/sausy/Projects/Hand_openBionic/catkin/src/common_utilities/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common_utilities' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sausy/Projects/Hand_openBionic/catkin/src/common_utilities/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT common_utilities_NUM_DUMMY_TARGETS)
      set(common_utilities_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::common_utilities::wrapped-linker-option${common_utilities_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR common_utilities_NUM_DUMMY_TARGETS "${common_utilities_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::common_utilities::wrapped-linker-option${common_utilities_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND common_utilities_LIBRARIES "${interface_target_name}")

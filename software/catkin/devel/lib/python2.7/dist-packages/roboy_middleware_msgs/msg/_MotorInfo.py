...
class MotorInfo(genpy.Message):
  _md5sum = "909c2f506ccb6dd86a9edc36c33290ad"
...
int32[] gearBoxRatio"""
  __slots__ = ['setpoint','control_mode','Kp','Ki','Kd','deadband','IntegralLimit','PWMLimit','pwm','communication_quality','gearBoxRatio']
  _slot_types = ['int32[]','uint8[]','int32[]','int32[]','int32[]','int32[]','int32[]','int32[]','int32[]','int32[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       setpoint,control_mode,Kp,Ki,Kd,deadband,IntegralLimit,PWMLimit,pwm,communication_quality,gearBoxRatio
